...
try:
    with psycopg2.connect(railway_url) as railway_conn, psycopg2.connect(local_url) as local_conn:
        ...
        with railway_conn.cursor() as railway_cur, local_conn.cursor() as local_cur:
